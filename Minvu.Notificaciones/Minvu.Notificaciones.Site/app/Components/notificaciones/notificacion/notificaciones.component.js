...
var notificacionesComponent = (function () {
    function notificacionesComponent() {
        this.titulo = "Enviar Notificaciones";
    }
    return notificacionesComponent;
}());
notificacionesComponent = __decorate([
    core_1.Component({
        selector: "notif-seleccion-sistemas-emisores",
        templateUrl: 'app/Components/notificaciones/notificacion/notificaciones.component.html'
    }),
